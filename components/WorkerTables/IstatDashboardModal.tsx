    ...
    useEffect(() => {
        ...
        const performCalculations = async () => {
            ...
            try {
                ...
                const indCols = getColumnsByProfile(worker.profilo, worker.eliorType).filter(c => !['month', 'total', 'daysWorked', 'daysVacation', 'daysPaidLeave', 'ticket', 'coeffPercepito', 'coeffTicket', 'note', 'arretrati', '3B70', '3B71'].includes(c.id));
